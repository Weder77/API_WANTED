...
class AppFixtures extends Fixture
{
    public function load(ObjectManager $manager)
    {
        ...
        $positions = array("[5,-19]", "[-76,-42]", "[-75,-74]", "Enutrosor [-1,-1]", "Srambad [2,2]", "Xelorium [1,6]", "[0,0]", "[5,-6]", "Profondeur de sufokia [23,26]", "Bonta [-33,-56] ou Brakmar [-26,36]", "Sabloon [15,-57]");
